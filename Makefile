...
setup-hedgehog: setup-server setup-server-raspberry setup-firmware

setup-hedgehog-develop: setup-server-develop setup-server-raspberry setup-firmware-develop
